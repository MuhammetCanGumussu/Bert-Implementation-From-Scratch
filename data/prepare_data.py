...
#TODO: custom veri setinde de çalışabilir hale getirilecek 
# raw'daki tüm dosyaları tek bir str yapmaktansa loop döngüsü içinde doc shard'lar
# oluşturulacak. (doc shards oluşumunda idx'lemelerin vs ayarlanması gerekli...)
# custom txt dosyalarında doc'lar "newline" ile seperate edilmiş olmak zorunda olacak
